...
<body>
    <form id="form1" runat="server">
        ...
        <div class="Login">
            ...
            <asp:UpdatePanel runat="server" UpdateMode="Always">
                <ContentTemplate>
                    ...
                    <asp:TextBox ID="Txt_Contraseña" runat="server" Width="200" TextMode="Password" MaxLength="10"></asp:TextBox>
                    <br />
                    <br />
                    <asp:Button ID="bt_Registro" runat="server" Text="Registrate" />
                    <asp:Button ID="bt_Login" runat="server" Text="Login" Width="80" OnClick="bt_Login_Click" />
        ...
        <asp:Panel ID="Panel1" runat="server" CssClass="modalpopup" Style="display: none" >
            ...
            <asp:Label ID="Label3" runat="server" Text="Nombre" Width="100">
            </asp:Label><asp:TextBox ID="Txt_NombreRegistro" runat="server" Width="200" MaxLength="20"></asp:TextBox>
            <br />
            <br />
            ...
            <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Las contraseñas no son iguales"
                ControlToCompare="Txt_Contrasena" ControlToValidate="Txt_ContrasenaConfirm" Display="Dynamic" Style="color: #FF0000"></asp:CompareValidator>
            <asp:Button ID="btnOkay" runat="server" Text="Guardar" />
